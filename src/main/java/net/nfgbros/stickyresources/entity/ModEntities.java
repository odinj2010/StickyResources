...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<JellyMagnetEntity>> JELLY_MAGNET =
            ENTITY_TYPES.register("jelly_magnet", () -> EntityType.Builder.of(JellyMagnetEntity::new, MobCategory.CREATURE)
                    .sized(0.75f, 0.75f).build("jelly_magnet"));
    //
    //
    //
