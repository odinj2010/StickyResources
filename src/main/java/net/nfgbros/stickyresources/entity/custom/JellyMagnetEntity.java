...
public class JellyMagnetEntity extends JellyEntity {
    ...
    public JellyMagnetEntity(EntityType<? extends JellyEntity> pEntityType, Level pLevel) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel pLevel, AgeableMob pOtherParent) {
        // Create a new JellyMagnetEntity as offspring
        return ModEntities.JELLY_MAGNET.get().create(pLevel);
    }
