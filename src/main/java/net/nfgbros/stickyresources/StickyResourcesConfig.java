...
public class StickyResourcesConfig {
    ...
    static {
        ...
        JELLY_MERGE_THRESHOLD = COMMON_BUILDER.comment("The number of ticks it takes to merge two Jellies together. (default = 40 (2 seconds), min = 1, max = 72000) (in ticks)")
                .defineInRange("jellyMergeThreshold", 40, 1, 72000);
        //
