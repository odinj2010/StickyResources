...
public class ModPlacedFeatures {
    public static final ResourceKey<PlacedFeature> SAPPHIRE_PLACED_KEY = registerKey("sapphire_placed");
    public static final ResourceKey<PlacedFeature> NETHER_SAPPHIRE_PLACED_KEY = registerKey("nether_sapphire_placed");
    public static final ResourceKey<PlacedFeature> END_SAPPHIRE_PLACED_KEY = registerKey("end_sapphire_placed");
